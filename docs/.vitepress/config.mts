        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: '金渐层', link: '/golden' },
              { text: '银渐层', link: '/silver' },
              { text: '布偶猫', link: '/ragdoll' },
              { text: '缅因猫', link: '/maine' },
              { text: '德文猫', link: '/devon' },
              { text: '虎斑', link: '/tabby' },
              { text: '拿破仑猫', link: '/napoleon' },
              { text: '暹罗猫', link: '/Siamese' },
              { text: '美短猫', link: '/American' },
              { text: '中华田园猫', link: '/Chinese' },
              { text: '金吉拉猫', link: '/Chinchilla' },
              { text: '加菲猫', link: '/Garfield' },
              { text: '波斯猫', link: '/Persian' },
            ],
          },
          {
            // 分组标题3
